...
if __name__ == '__main__':
    ...
    pg = PacketGenerator(env, "SJSU", const_arrival, const_size, initial_delay=0.0, finish=3.5)
    pg2 = PacketGenerator(env, "SJSU", const_arrival, const_size, initial_delay=0.0, finish=3.5)
    ...
    bucket_rate = (1.0/7.0)*source_rate
    bucket_size = 4*const_size()
